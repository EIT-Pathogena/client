...
def _write_csv(
    ...
    if upload_data.amplicon_scheme == None:
        logging.warning(f"No amplicon scheme has been specified, automatic detection will be used.")
        logging.warning("Note that selecting automatic detection may occasionally result in misclassification "
