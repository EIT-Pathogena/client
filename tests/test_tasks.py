...
@patch("httpx.Client.get")
@patch("pathogena.tasks.get_access_token")
def test_get_balance(
    ...
    Args:
        mock_token (MagicMock): Mocked `pathogena.tasks.get_access_token` method.
        mock_get (MagicMock): Mocked `httpx.Client.get` method.
        caplog (pytest.LogCaptureFixture): Pytest fixture to capture log output.
    """
    caplog.set_level(logging.INFO)
    ...
    tasks.get_credit_balance(host="fake_host")
